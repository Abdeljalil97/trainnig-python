...
class monprogramme:
      def __init__(self):
            ...
            events = { 'on_button1_clicked': self.monclic, 'delete': self.delete } self.widgets.signal_autoconnect(events)
            ...
            return True if __name__ == '__main__': app = monprogramme() gtk.main()
